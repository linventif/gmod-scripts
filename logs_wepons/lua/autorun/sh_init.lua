...
local folder = "logs_weapons"
logs_weapons = {}
logs_weapons.version = 1

// Load Config File
AddCSLuaFile(folder .. "/sh_config.lua")
include(folder .. "/sh_config.lua")
print("| Logs Weapons | File Load | addons/" .. folder .. "/lua/" .. folder .. "co.lua")
...
print("| Logs Weapons | File Load | addons/" .. folder .. "/lua/" .. folder .. "/languages/" .. string.lower(Learn_Skills.Config.Language) .. ".lua")
